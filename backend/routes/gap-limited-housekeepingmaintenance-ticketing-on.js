...
const FEATURE_SLUG = 'limited-housekeepingmaintenance-ticketing-on';
const FEATURE_TITLE = 'Limited housekeeping/maintenance ticketing (only maintenance.js stub)';
