...
const FEATURE_SLUG = 'no-automated-guest-communications-confirmati';
const FEATURE_TITLE = 'No automated guest communications (confirmation, reminder, review request)';
const PROJECT = 'AIRVParkCampgroundManager';
