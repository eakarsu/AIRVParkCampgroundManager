...
export default function GapNoAutomatedGuestCommunicationsConfirmati() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-automated-guest-communications-confirmati', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No automated guest communications (confirmation, reminder, review request)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIRVParkCampgroundManager - Gap feature</p>
